...
import api from "../services/api"; // Interceptor ekli olan axios örneğimiz
...
export default function ProductsPage() {
  ...
  useEffect(() => {
    // baseURL zaten api.js içinde "http://localhost:5234/api" olarak tanımlı olduğu için
    // sadece endpoint yolunu veriyoruz. Interceptor otomatik Bearer Token ekleyecek.
    api
      .get("/Products")
      .then((response) => {
